...
public class SpringJpaApplication2 {
    ...
    public static void main(String[] args) {
        ...
        // Récupérer une implémentation de l'interface "ProduitMetierInterface" par injection de dépendance
        produitMetier = contexte.getBean(ProduitMetierInterface.class);
        // Récupérer une implémentation de l'interface "CategorieMetierInterface" par injection de dépendance
        ...
        categorieMetier.ajouterCategorie(catInformatique); // Ajouter la catégorie
        ...
        categorieMetier.ajouterCategorie(catJouet); // Ajouter la catégorie
        ...
        System.out.println("-8-Afficher toutes les catégories");
    ...
    static void afficherToutesLesCategories() {
        System.out.println("********************Début**********************");
        System.out.println("Afficher toutes les catégories...");
        System.out.println("***********************************************");

        List<Categorie> lc = categorieMetier.listeCategories();
        for (Categorie c : lc) {
